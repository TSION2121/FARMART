...
<?php
	...
	if(isset($_GET['delete_id']))
	{
		...
		$stmt_delete = $DB_con->prepare('DELETE FROM buyerregistration WHERE buyer_id =:buyer_id');
		$stmt_delete->bindParam(':buyer_id',$_GET['delete_id']);
		$stmt_delete->execute();
...
<head>
    ...
    <title>FARMART - Customer Info</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="customers.php" style="color: #2ecc71"> &nbsp; &nbsp; &nbsp; Customer Management</a></li>
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger">
                          ...
                          <center> <h3 style="color:#2ecc71"><strong>Customer Management</strong> </h3></center>
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
			  ...
			  <?php
include("config.php");
$mail=$_POST['buyer_mail'];
$name=$_POST['buyer_name'];
$address=$_POST['buyer_addr'];



	$stmt = $DB_con->prepare('SELECT * FROM buyerregistration');
	$stmt->execute();
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
                <tr>
				 ...
				 <a class="btn btn-success" href="view_orders.php?view_id=<?php echo $row['buyer_id']; ?>"><span class='glyphicon glyphicon-shopping-cart'></span> View Orders</a> 
				  <!-- <a class="btn btn-warning" href="?order_id=<?php echo $row['buyer_id']; ?>" title="click for delete" onclick="return confirm('Are you sure to reset the customer items ordered?')">
				 ...
				 -->
                  ...
                  <a class="btn btn-danger" href="?delete_id=<?php echo $row['buyer_id']; ?>" title="click for delete" onclick="return confirm('Are you sure to remove this customer?')">
