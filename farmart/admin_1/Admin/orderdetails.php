...
<?php
	...
	if(isset($_GET['delete_id']))
	{
		...
		$stmt_delete = $DB_con->prepare('DELETE FROM orders WHERE order_id =:order_id');
...
<head>
    ...
    <title>FARMART - Order Details</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a data-toggle="modal" data-target="#uploadModal" style="color:#2ecc71;"> &nbsp; &nbsp; &nbsp; Upload Items</a></li>
					...
					<li class="active"><a href="orderdetails.php" style="color:#2ecc71;"> &nbsp; &nbsp; &nbsp; Order Details</a></li>
        ...
        <div id="page-wrapper">
		 ...
		 <div class="alert alert-danger">
                          ...
                          <center> <h3 style="color:#2ecc71"><strong>Order Details Management</strong> </h3></center>
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
			  ...
			  <?php
include("config.php");
	$stmt = $DB_con->prepare('select order_id, order_date,buyerregistration.buyer_name, product_title, total from orders, buyerregistration where orders.buyer_id=buyerregistration.buyer_id');
	$stmt->execute();
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo '<div class="alert alert-default" style="background-color:#2ecc71;">
                       ...
                       &copy 2022 FARMART | All Rights Reserved |  Design by : EDGE Team
