...
<head>
    ...
    <title>FARMART - Preious Order</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">FARMART - Administrator Panel</a>
            </div>
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger">
                          ...
                          <center> <h3 style="color:#2ecc71"><strong>Customer Previous Item Ordered</strong> </h3></center>
