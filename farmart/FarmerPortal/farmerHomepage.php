          ...
          -->
                ...
                <div class=" flex-row-reverse right ">
                    ...
                    <span id="icon" style="color:green"> 5 </span>
                          ...
                          <div class='loginz' style="color:#2ecc71">
                               <?php getFarmerUsername(); ?>
                          </div>
           ...
           <div class="row" style="text-align:center;">
                ...
                <div class="col-md-3 col-sm-12">
                     <a href="CallCenter.php" id="navbar"><i class="fa fa-phone fa-rotate-vertical" aria-hidden="true"></i><label>Call Center & SMS</label></a>
                </div>
           </div>
           <hr>
           ...
           <div class="features container">
                <h1 style="font-weight: bold;color:#2ecc71; text-align:center">Standout Features</h1>
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     <div class="card">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold" style="color:#2ecc71">Sms System </h4>
                               <br>
                               <h5 class="card-text" style="color:#2ecc71">Upload and Edit Your Products via SMS </h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold" style="color:#2ecc71">Buyer Connection</h4>
                               <br>
                               <h5 class="card-text" style="color:#2ecc71">Get in direct touch with the buyer to satisfy its need </h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold" style="color:#2ecc71">Farmer Group Formation</h4>
                               <br>
                               <h5 class="card-text" style="color:#2ecc71">Get in touch with other farmers making your own community where you can ask for help</h5>
                          </div>
                     </div>
                </div>
           </div>
