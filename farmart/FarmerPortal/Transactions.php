...
<body>
     ...
     -->
          ...
          <div style="display:block;">
               ...
               <div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray; color:#2ecc71;"><b>TRANSACTION HISTORY</b></label></div>
               <br>
          </div>
          ...
          <div class="container">
               ...
               <table class="table" style="color:#2ecc71">
                    <thead>
                         <th style="color:#2ecc71">Product Name</th>
                         <th style="color:#2ecc71">Name</th>
                         <th style="color:#2ecc71">Phone Number</th>
                         <th style="color:#2ecc71">Delivery Address</th>
                         <th style="color:#2ecc71">Quantity</th>
                         <th style="color:#2ecc71">Amount</th>
                    </thead>
