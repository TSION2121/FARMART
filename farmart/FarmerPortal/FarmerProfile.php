...
<div class="just">
    ...
    <div class="container-fluid" style="max-width:520px">
        <form action="EditProfile.php" method="post">
            <table align="center">
                <tr colspan=2>
                    <h1 style="color:#2ecc71"> FARMER'S PROFILE</h1>
                </tr>
                <tr align="center">
                    <td><label><b style="color:#2ecc71">Name :</b></label></td>
                    <td>
