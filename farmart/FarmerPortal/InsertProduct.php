                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-center font-weight-bold" style="color: #2ecc71">Insert Your New Product <i class="fas fa-leaf"></i></h4>
                            </div>
                            <div class="card-body">
                                ...
                                <form name="my-form" action="InsertProduct.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label for="full_name" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder" style="color: #2ecc71">Product Title:</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="email_address" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder" style="color: #2ecc71">Product Stock:(In kg)</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="user_name" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder" style="color: #2ecc71">Product Categories:</label>
                                        <div class="col-md-6">
                                            <select name="product_cat" required>
                                                <option style="color: #2ecc71">Select a Category</option>
                                                <?php
                                    ...
                                    <div class="form-group row">
                                        <label for="phone_number" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder" style="color: #2ecc71">Product type :</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="present_address" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder" style="color: #2ecc71">Product Expiry :</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="permanent_address" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder" style="color: #2ecc71">Product Image :</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="nid_number" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder" style="color: #2ecc71">Product MRP : (Per kg)</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="nid_number2" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder" style="color: #2ecc71"> Product Description:</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="nid_number3" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder" style="color: #2ecc71">Product Keywords:</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="nid_number4" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder" style="color: #2ecc71">Delivery :</label>
                                        <div class="col-md-6">
                                            <input type="radio" id="nid_number4" name="product_delivery" value="yes" style="color: #2ecc71"/> Yes
                                            <input type="radio" id="nid_number4" name="product_delivery" value="no" style="color: #2ecc71"/> No
                                        </div>
                                    </div>
                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary" name="insert_pro" style="background-color: #2ecc71">
                                            INSERT
                                        </button>
                                    </div>
                                </form>
