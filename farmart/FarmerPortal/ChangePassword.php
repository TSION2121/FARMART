...
<body>
    ...
    <div class="box">
        <form action="" method="post">
            <table align="center">
                <tr colspan=2>
                    <h1 style="color:#2ecc71">CHANGE PASSWORD </h1>
                </tr>
                <tr align="center">
                    <td>
                        <label><b style="color:#2ecc71">Current Password:</b></label>
                    </td>
                    <td>
                ...
                <tr align="center">
                    <td>
                        <label><b style="color:#2ecc71">New Password:</b></label>
                    </td>
                    <td>
                ...
                <tr align="center">
                    <td>
                        <label><b style="color:#2ecc71">Re-enter Password:</b></label>
                    </td>
                    <td>
