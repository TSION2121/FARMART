...
<table>
        <tr id="protitle">
            <td>
                <div class="grp1">
                    ...
                    <div class="col2"><label class="text1" name="product_title" required>Gladina</div>
            </td>
            ...
            <td>
                <div class="grp2">
                    ...
                    <div class="col4">
                    <label class="text1" name="product_title" >9819104641</label>            
               </div>
        ...
        <tr id="protitle">
            <td>
                <div class="grp1">
                    <div class="col t1"><b> Address</b> </div>
                    <div class="col4">
                    <label class="text1" name="product_title" required>mumbai</label>
            </td>
            <td>
     ...
     <div class="footer">
          ...
          <div class="cash"><img src="../Images/Website/telebirr.png" height="75px" width="125px"></div>
          <div class="patym"><img src="../Images/Website/cbe.jpg" height="75px" width="125px"></div>
     </div><br><br>
...
<br><br>
          <div class="gmail">
               <img src="../Images/Website/gmail.jpg" height="30px" width="50px"> <br><br>
          </div>
          <br><br>
     
     <div class="instaid">
          <div class="text"><a href="#" style="color:black;">@Farmart</a></div>

          <div class="gmailid">
               <a href="#" class="hypher" style="color:black;">farmart@gmail.com</a>
          </div>

     </div>
     <div class="copy">
          <h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.farmart.com</h5>
     </div>
