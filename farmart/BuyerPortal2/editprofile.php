...
<body>
    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse left ">
            ...
            <div class="p-2">
                <div class="icon2">
                    <a href="CartPage.php"> <i class="fa" style="font-size:30px; color:black ;margin-top:2px;">&#61562;</i></a>
                    <span id="icon" style="color:black">  </span>
                </div>
            </div>
...
<br>
        <b>
            <h1 class="guard" style="color:black;"><span><b>Edit  Profile</b></span>
            </h1>
        </b>
        <br>
    </div></div>
    ...
    <div class="container" >
        <div class="form">
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" style="color:black;background-color:#2ecc71"><i class="fas fa-user mr-2" style="color:black;"></i>Full name</span>
                </div>
                <input type="text"  class="form-control border border-dark" id="staticEmail" value="<?php echo $name?>">
            </div>
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" style="color:black;background-color:#2ecc71"><i class="fas fa-phone-alt mr-2" style="color:black;"></i>Phone No.</span>
                </div>
                <input type="phonenumber"  class="form-control border border-dark" id="staticEmail" value="<?php echo $phone?>">
            </div>
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" style="color:black;background-color:#2ecc71"><i class="fas fa-home mr-2" style="color:black;"></i>Address</span>
                </div>
                <input type="text"  class="form-control border border-dark" id="staticEmail" value="<?php echo $address?>">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" style="color:black;background-color:#2ecc71"><i class="fas fa-pencil-alt mr-2" style="color:black;"></i>Zip Code</span>
                </div>
                <input type="number" readonly class="form-control-plaintext border border-dark" id="staticEmail" value=" <?php echo $pan?> ">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" style="color:black;background-color:#2ecc71"style="color:black;background-color:#2ecc71"><i class="fas fa-university mr-2" style="color:black;"></i>Account No.</span>
                </div>
                <input type="number"  class="form-control border border-dark" id="staticEmail" value=" <?php echo $bank?>">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" style="color:black;background-color:#2ecc71"><i class="fas fa-building mr-2" style="color:black;"></i>Company</span>
                </div>
                <input type="number"  class="form-control border border-dark" id="staticEmail" value="<?php echo $comp?>">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" style="color:black;background-color:#2ecc71"><i class="fas fa-id-badge mr-2" style="color:black;"></i>License</span>
                </div>
                <input type="number" readonly class="form-control-plaintext border border-dark" id="staticEmail" value=" <?php echo $license?>">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" style="color:black;background-color:#2ecc71"><i class="far fa-envelope mr-2" style="color:black;"></i>Email id </span>
                </div>
                <input type="email"  class="form-control border border-dark" id="staticEmail" value="<?php echo $mail?> ">
            </div> 
        </div>
        <button type="button" class="btn text-center d-flex mx-auto btn-lg" style="color:black;background-color:#2ecc71">Confirm</button>
        <br>
        <button type="button" class="btn text-center d-flex mx-auto btn-lg" style="color:black;background-color:#2ecc71">Change Password</button>
    </div>
