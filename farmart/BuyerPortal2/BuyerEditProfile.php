        ...
        <form action="" method = "post">
             <table align = "center" >
                ...
                <tr colspan =2 align = "center">
                    <td colspan =2>
                        <input type="submit" name="confirm" value="Confirm" style="background-color: #2ecc71;">
                    </td>
                </tr>
            </table>
        </form>
        <div class="again">
            <td colspan =2><a href="BuyerChangePassword.php" ><button class="say" style="background-color: #2ecc71;">Change Password</button></a></td>
        </div>
