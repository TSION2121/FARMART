...
<div class=" flex-row-reverse right ">
    ...
    <div class="container">
        ...
        <div class="text-left ">
            <h2>Save For later
                <div class="text-right" ><button type="button" class="btn btn-warning border border-dark " style="margin-top:-5%; background-color: #2ecc71;"><b style="background-color: #2ecc71;">Delete all</b></button></div>
            </h2>
        ...
        <div class="row">
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2 ">
                    <br>
                    <div><b>
                            <h3><img src="iconsmall.png"> Abebe
                        </b>
                       <button class="cross" style="border-style:none;background-color:transparent;"><i class="fas fa-times"style=""></i></button>
                        </h3>

                    </div>
                    <img class="card-img-top" src="Bananas.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Banana</h5>
                        <p class="card-text">PRICE:-20ETB/kg</p>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend" >
                                <span class="input-group-text bg-warning border-secondary" id="inputGroup-sizing-default" style="color:black;background-color:#2ecc71;"><b>Quantity</b></span>
                            </div>
                            <input type="number" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                        </div>
                        <a href="#" class="btn btn-warning border-secondary" style="color:black;  background-color:#2ecc71"><b>Add to cart</b><img src="carticons.png"></a>
                    </div>
                </div>
            </div>
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card  pl-3 pr-3 pb-0 pt-2 mt-2 ">
                    ...
                    <img class="card-img-top pic" src="strawberry.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Strawberry</h5>
                        <p class="card-text">PRICE:-58ETB/kg</p>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-warning border-secondary" style="color:black;  background-color:#2ecc71" id="inputGroup-sizing-default"><b>Quantity</b></span>
                            </div>
                            <input type="number" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                        </div>
                        <a href="#" class="btn btn-warning border-secondary" style="color:black;  background-color:#2ecc71"><b>Add to cart</b><img src="carticons.png"></a>
            ...
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2  ">
                    <br>
                    <div><b>
                            <h3><img src="iconsmall.png"> kebde
                        </b></h3>
                    </div>
                    <img class="card-img-top" src="Green Grapes.jpg" alt="Card image cap">
                    <div class="card-body">
        ...
        <div class="row mt-3">
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2  ">
                    <br>
                    <div><b>
                            <h3><img src="iconsmall.png"> Alemu
                        </b></h3>
                    </div>
                    <img class="card-img-top" src="Mango.jpg" alt="Card image cap" height="315px">
                    <div class="card-body">
            ...
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2 ">
                    <br>
                    <div><b>
                            <h3><img src="iconsmall.png"> Yeshak
                        </b></h3>
                    </div>
                    <img class="card-img-top" src="Mango.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Mango</h5>
                        <p class="card-text">PRICE:-20ETB/kg</p>
                        <div class="input-group mb-3">
