...
<body>
    ...
    <div class="container">
        <div class="text-left">
            <h3 class="mt-2" style="color:#2ecc71">Your Transactions </h3>
        ...
        <table class="table">
            <thead>
                <th style="color:#fff">Farmer Name</th>
                <th style="color:#fff">Phone</th>
                <th style="color:#fff">Delivery Address</th>
                <th style="color:#fff">Product</th>
                <th style="color:#fff">Quantity</th>
                <th style="color:#fff">Delivary mode</th>
...
<?php
        ...
        <br><br>
        <a href="bhome.php">
            <button type="button" class="btn  btn-lg border border-dark" style="background-color:#2ecc71;color:black;">Continue Shopping
