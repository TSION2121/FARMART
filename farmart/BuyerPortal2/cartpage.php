    ...
    <div class="container">
        ...
        <table class="table">
            <thead style="background-color:#2ecc71">
                ...
                <th style="width:25%; color:#fff">Quantity</th>
            ...
            ?>
                        ...
                        <tbody>
                            <tr>
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <a href="AddQty.php?id=<?php echo $product_id; ?>">
                                                    <button class="btn btn-outline-secondary" style=" background-color:#2ecc71;" type="button" id="button-addon1">
                                                        <b style="color:#fff"><i class="fas fa-plus"></i></b>
                                                    </button>
                                                </a>
                                            </div>
                                            ...
                                            <div class="input-group-append">
                                                <a href="MinusQty.php?id=<?php echo $product_id; ?>">
                                                    <button class="btn btn-outline-secondary" style=" background-color:#2ecc71;" type="button" id="button-addon2">
                                                        <b style="color:#fff"><i class="fas fa-minus"></i></b>
                                                    </button>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <td data-label="Delete" style="font-size:20px; color:#2ecc71"><a href="DeleteProductCart.php?id=<?php echo $product_id; ?>" id="Deletionlink"><i class="far fa-times-circle" style="color:#2ecc71"></i></a></td>
                            </tr>
                <?php
                    }
                    $i++;
    ...
    <div class="container">
        <div class="float-none float-sm-none float-md-none float-lg-left float-xl-left  emptycart">
            <a href="emptyCart.php">
                <button type="button" class="btn btn-lg  border border-dark " style="font-size:22px;color:black;background-color:#2ecc71">Empty Cart
        ...
        <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 border border-dark  " style="border-radius:5%;">
            ...
            <h2>Grand total = ETB <?php echo $total; ?> </h2>
            ...
            if (isset($_SESSION['phonenumber'])) {
                ...
                if ($count > 0) {
                    echo "<a href='Checkout.php'>
                                <button type='button' class='btn btn-lg border border-dark d-flex mx-auto' style='font-size:22px;color:black;background-color:#2ecc71'>
        ...
        <div class=" float-none float-sm-none float-md-none float-lg-left float-xl-left continueshopping mt-5">
            <a href="bhome.php"><button type="button" class="btn btn-lg  border border-dark " style="font-size:22px;color:black;background-color:#2ecc71">Continue Shopping
